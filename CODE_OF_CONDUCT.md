...
No interesse de promover um ambiente aberto e acolhedor, nós, como contribuidores e mantenedores, comprometemo-nos a tornar a participação em nosso projeto e em nossa comunidade uma experiência livre de assédio para todos, independentemente de:
...
Este Código de Conduta se aplica tanto em espaços do projeto quanto em espaços públicos quando um indivíduo está representando o projeto ou sua comunidade. Exemplos de representação de um projeto ou comunidade incluem:
...
Valorizamos todas as contribuições e acreditamos que um ambiente positivo e respeitoso é essencial para o sucesso do projeto. Obrigado por ajudar a tornar esta uma comunidade acolhedora para todos!
